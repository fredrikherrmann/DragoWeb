...
const translations = {
  sv: {
    ...
    rs_feat7_title: "Bildhantering", rs_feat7_desc: "Lägg till bilder direkt från kameran eller filsystemet. Beskärning, bildtexter och automatisk numrering i rapporten.",
    ...
    rs_feat9_title: "Smart sökning", rs_feat9_desc: "Hitta rapporter, projekt och kunder med kraftfull sökning. Filtrera på datum, status, typ och fritext.",
  ...
  en: {
    ...
    rs_feat7_title: "Image handling", rs_feat7_desc: "Add images directly from the camera or file system. Cropping, captions and automatic numbering in the report.",
    ...
    rs_feat9_title: "Smart search", rs_feat9_desc: "Find reports, projects and clients with powerful search. Filter by date, status, type and free text.",
  ...
  de: {
    ...
    rs_feat7_title: "Bildverwaltung", rs_feat7_desc: "Fügen Sie Bilder direkt von der Kamera oder dem Dateisystem hinzu. Zuschnitt, Bildunterschriften und automatische Nummerierung.",
    ...
    rs_feat9_title: "Intelligente Suche", rs_feat9_desc: "Finden Sie Berichte, Projekte und Kunden mit leistungsstarker Suche. Filtern nach Datum, Status, Typ und Freitext.",
  ...
  fr: {
    ...
    rs_feat7_title: "Gestion d'images", rs_feat7_desc: "Ajoutez des images depuis l'appareil photo ou le système de fichiers. Recadrage, légendes et numérotation automatique.",
    ...
    rs_feat9_title: "Recherche intelligente", rs_feat9_desc: "Trouvez rapports, projets et clients avec une recherche puissante. Filtrez par date, statut, type et texte libre.",
  ...
  es: {
    ...
    rs_feat7_title: "Gestión de imágenes", rs_feat7_desc: "Añade imágenes desde la cámara o el sistema de archivos. Recorte, subtítulos y numeración automática.",
    ...
    rs_feat9_title: "Búsqueda inteligente", rs_feat9_desc: "Encuentra informes, proyectos y clientes con búsqueda potente. Filtra por fecha, estado, tipo y texto libre.",
  ...
  it: {
    ...
    rs_feat7_title: "Gestione immagini", rs_feat7_desc: "Aggiungi immagini dalla fotocamera o dal file system. Ritaglio, didascalie e numerazione automatica.",
    ...
    rs_feat9_title: "Ricerca intelligente", rs_feat9_desc: "Trova report, progetti e clienti con ricerca potente. Filtra per data, stato, tipo e testo libero.",
  ...
  pt: {
    ...
    rs_feat7_title: "Gestão de imagens", rs_feat7_desc: "Adicione imagens da câmera ou do sistema de arquivos. Recorte, legendas e numeração automática.",
    rs_feat8_title: "Multilíngue", rs_feat8_desc: "Escreva relatórios em sueco, inglês e mais idiomas. Mude o idioma por relatório.",
    rs_feat9_title: "Pesquisa inteligente", rs_feat9_desc: "Encontre relatórios, projetos e clientes com pesquisa poderosa. Filtre por data, status, tipo e texto livre.",
  ...
  nl: {
    ...
    rs_feat7_title: "Beeldbeheer", rs_feat7_desc: "Voeg afbeeldingen toe vanaf de camera of het bestandssysteem. Bijsnijden, bijschriften en automatische nummering.",
    rs_feat8_title: "Meertalig", rs_feat8_desc: "Schrijf rapporten in het Zweeds, Engels en meer talen. Wissel van taal per rapport.",
    rs_feat9_title: "Slim zoeken", rs_feat9_desc: "Vind rapporten, projecten en klanten met krachtig zoeken. Filter op datum, status, type en vrije tekst.",
  ...
  da: {
    ...
    rs_feat7_title: "Billedhåndtering", rs_feat7_desc: "Tilføj billeder fra kameraet eller filsystemet. Beskæring, billedtekster og automatisk nummerering.",
    rs_feat8_title: "Flersproget", rs_feat8_desc: "Skriv rapporter på svensk, engelsk og flere sprog. Skift sprog per rapport.",
    rs_feat9_title: "Smart søgning", rs_feat9_desc: "Find rapporter, projekter og kunder med kraftfuld søgning. Filtrér efter dato, status, type og fri tekst.",
  ...
  no: {
    ...
    rs_feat7_title: "Bildebehandling", rs_feat7_desc: "Legg til bilder fra kameraet eller filsystemet. Beskjæring, bildetekster og automatisk nummerering.",
    rs_feat8_title: "Flerspråklig", rs_feat8_desc: "Skriv rapporter på svensk, engelsk og flere språk. Bytt språk per rapport.",
    rs_feat9_title: "Smart søk", rs_feat9_desc: "Finn rapporter, prosjekter og kunder med kraftig søk. Filtrer etter dato, status, type og fri tekst.",
    ...
    rs_feat7_title: "Kuvankäsittely", rs_feat7_desc: "Lisää kuvia kamerasta tai tiedostojärjestelmästä. Rajaus, kuvatekstit ja automaattinen numerointi.",
    ...
    rs_feat9_title: "Älykäs haku", rs_feat9_desc: "Löydä raportit, projektit ja asiakkaat tehokkaalla haulla. Suodata päivämäärän, tilan, tyypin ja vapaan tekstin mukaan.",
  ...
  pl: {
    ...
    rs_feat7_title: "Zarządzanie zdjęciami", rs_feat7_desc: "Dodawaj zdjęcia z aparatu lub systemu plików. Kadrowanie, podpisy i automatyczna numeracja.",
    rs_feat8_title: "Wielojęzyczny", rs_feat8_desc: "Pisz raporty po szwedzku, angielsku i w innych językach. Zmień język per raport.",
    rs_feat9_title: "Inteligentne wyszukiwanie", rs_feat9_desc: "Znajdź raporty, projekty i klientów dzięki potężnemu wyszukiwaniu. Filtruj po dacie, statusie, typie i wolnym tekście.",
