...
const translations = {
  sv: {
    ...
    // DragoRS page
    rs_hero_desc: "Komplett rapportgenerator för bygg, projektledare och fukt- och skadebranschen. Skapa professionella rapporter med mätprotokoll, bildhantering, PDF-export och flerspråkigt stöd — direkt i webbläsaren.",
    ...
    rs_feat4_title: "Bildhantering", rs_feat4_desc: "Lägg till bilder direkt från kameran eller filsystemet. Beskärning, bildtexter och automatisk numrering i rapporten.",
    rs_feat5_title: "Flerspråkigt stöd", rs_feat5_desc: "Skriv rapporter på svenska, engelska och fler språk. Byt språk per rapport — perfekt för internationella uppdrag.",
    rs_feat6_title: "Smart sökning", rs_feat6_desc: "Hitta rapporter, projekt och kunder med kraftfull sökning. Filtrera på datum, status, typ och fritext.",
  ...
  en: {
    ...
    // DragoRS page
    rs_hero_desc: "Complete report generator for construction, project managers and the moisture and damage industry. Create professional reports with measurement protocols, image handling, PDF export and multilingual support — directly in the browser.",
    ...
    rs_feat4_title: "Image handling", rs_feat4_desc: "Add images directly from the camera or file system. Cropping, captions and automatic numbering in the report.",
    rs_feat5_title: "Multilingual support", rs_feat5_desc: "Write reports in Swedish, English and more languages. Switch language per report — perfect for international assignments.",
    rs_feat6_title: "Smart search", rs_feat6_desc: "Find reports, projects and clients with powerful search. Filter by date, status, type and free text.",
  ...
  de: {
    ...
    rs_hero_desc: "Kompletter Berichtgenerator für Bau, Projektleiter und die Feuchtigkeits- und Schadenbranche. Erstellen Sie professionelle Berichte mit Messprotokollen, Bildverwaltung, PDF-Export und mehrsprachiger Unterstützung — direkt im Browser.",
    ...
    rs_feat4_title: "Bildverwaltung", rs_feat4_desc: "Fügen Sie Bilder direkt von der Kamera oder dem Dateisystem hinzu. Zuschnitt, Bildunterschriften und automatische Nummerierung.",
    rs_feat5_title: "Mehrsprachig", rs_feat5_desc: "Schreiben Sie Berichte in Schwedisch, Englisch und weiteren Sprachen. Sprachwechsel pro Bericht — perfekt für internationale Aufträge.",
    rs_feat6_title: "Intelligente Suche", rs_feat6_desc: "Finden Sie Berichte, Projekte und Kunden mit leistungsstarker Suche. Filtern nach Datum, Status, Typ und Freitext.",
  ...
  fr: {
    ...
    rs_hero_desc: "Générateur de rapports complet pour le bâtiment, les chefs de projet et le secteur de l'humidité et des sinistres. Créez des rapports professionnels avec protocoles de mesure, gestion d'images, export PDF et support multilingue — directement dans le navigateur.",
    ...
    rs_feat4_title: "Gestion d'images", rs_feat4_desc: "Ajoutez des images depuis l'appareil photo ou le système de fichiers. Recadrage, légendes et numérotation automatique.",
    rs_feat5_title: "Multilingue", rs_feat5_desc: "Rédigez des rapports en suédois, anglais et d'autres langues. Changez de langue par rapport — parfait pour les missions internationales.",
    rs_feat6_title: "Recherche intelligente", rs_feat6_desc: "Trouvez rapports, projets et clients avec une recherche puissante. Filtrez par date, statut, type et texte libre.",
  ...
  es: {
    ...
    rs_hero_desc: "Generador de informes completo para construcción, jefes de proyecto y el sector de humedad y daños. Crea informes profesionales con protocolos de medición, gestión de imágenes, exportación PDF y soporte multilingüe — directamente en el navegador.",
    ...
    rs_feat4_title: "Gestión de imágenes", rs_feat4_desc: "Añade imágenes desde la cámara o el sistema de archivos. Recorte, subtítulos y numeración automática.",
    rs_feat5_title: "Multilingüe", rs_feat5_desc: "Escribe informes en sueco, inglés y más idiomas. Cambia de idioma por informe — perfecto para encargos internacionales.",
    rs_feat6_title: "Búsqueda inteligente", rs_feat6_desc: "Encuentra informes, proyectos y clientes con búsqueda potente. Filtra por fecha, estado, tipo y texto libre.",
  ...
  it: {
    ...
    rs_hero_desc: "Generatore di report completo per edilizia, project manager e il settore umidità e danni. Crea report professionali con protocolli di misurazione, gestione immagini, esportazione PDF e supporto multilingue — direttamente nel browser.",
    ...
    rs_feat4_title: "Gestione immagini", rs_feat4_desc: "Aggiungi immagini dalla fotocamera o dal file system. Ritaglio, didascalie e numerazione automatica.",
    rs_feat5_title: "Multilingue", rs_feat5_desc: "Scrivi report in svedese, inglese e altre lingue. Cambia lingua per report — perfetto per incarichi internazionali.",
    rs_feat6_title: "Ricerca intelligente", rs_feat6_desc: "Trova report, progetti e clienti con ricerca potente. Filtra per data, stato, tipo e testo libero.",
  ...
  pt: {
    ...
    rs_hero_desc: "Gerador de relatórios completo para construção, gerentes de projeto e o setor de umidade e danos. Crie relatórios profissionais com protocolos de medição, gestão de imagens, exportação PDF e suporte multilíngue — diretamente no navegador.",
    ...
    rs_feat4_title: "Gestão de imagens", rs_feat4_desc: "Adicione imagens da câmera ou do sistema de arquivos. Recorte, legendas e numeração automática.",
    rs_feat5_title: "Multilíngue", rs_feat5_desc: "Escreva relatórios em sueco, inglês e mais idiomas. Mude o idioma por relatório.",
    rs_feat6_title: "Pesquisa inteligente", rs_feat6_desc: "Encontre relatórios, projetos e clientes com pesquisa poderosa. Filtre por data, status, tipo e texto livre.",
  ...
  nl: {
    ...
    rs_hero_desc: "Complete rapportgenerator voor bouw, projectleiders en de vocht- en schadebranche. Maak professionele rapporten met meetprotocollen, beeldbeheer, PDF-export en meertalige ondersteuning — direct in de browser.",
    ...
    rs_feat4_title: "Beeldbeheer", rs_feat4_desc: "Voeg afbeeldingen toe vanaf de camera of het bestandssysteem. Bijsnijden, bijschriften en automatische nummering.",
    rs_feat5_title: "Meertalig", rs_feat5_desc: "Schrijf rapporten in het Zweeds, Engels en meer talen. Wissel van taal per rapport.",
    rs_feat6_title: "Slim zoeken", rs_feat6_desc: "Vind rapporten, projecten en klanten met krachtig zoeken. Filter op datum, status, type en vrije tekst.",
  ...
  da: {
    ...
    rs_hero_desc: "Komplet rapportgenerator til byggeri, projektledere og fugt- og skadebranchen. Opret professionelle rapporter med måleprotokoller, billedhåndtering, PDF-eksport og flersproget support — direkte i browseren.",
    ...
    rs_feat4_title: "Billedhåndtering", rs_feat4_desc: "Tilføj billeder fra kameraet eller filsystemet. Beskæring, billedtekster og automatisk nummerering.",
    rs_feat5_title: "Flersproget", rs_feat5_desc: "Skriv rapporter på svensk, engelsk og flere sprog. Skift sprog per rapport.",
    rs_feat6_title: "Smart søgning", rs_feat6_desc: "Find rapporter, projekter og kunder med kraftfuld søgning. Filtrér efter dato, status, type og fri tekst.",
  ...
  no: {
    ...
    rs_hero_desc: "Komplett rapportgenerator for bygg, prosjektledere og fukt- og skadebransjen. Lag profesjonelle rapporter med måleprotokoller, bildebehandling, PDF-eksport og flerspråklig støtte — direkte i nettleseren.",
    ...
    rs_feat4_title: "Bildebehandling", rs_feat4_desc: "Legg til bilder fra kameraet eller filsystemet. Beskjæring, bildetekster og automatisk nummerering.",
    rs_feat5_title: "Flerspråklig", rs_feat5_desc: "Skriv rapporter på svensk, engelsk og flere språk. Bytt språk per rapport.",
    rs_feat6_title: "Smart søk", rs_feat6_desc: "Finn rapporter, prosjekter og kunder med kraftig søk. Filtrer etter dato, status, type og fri tekst.",
    ...
    rs_hero_desc: "Täydellinen raporttityökalu rakentamiseen, projektipäälliköille ja kosteus- ja vahinkoalalle. Luo ammattimaisia raportteja mittausprotokollin, kuvankäsittelyn, PDF-viennin ja monikielisen tuen avulla — suoraan selaimessa.",
    ...
    rs_feat4_title: "Kuvankäsittely", rs_feat4_desc: "Lisää kuvia kamerasta tai tiedostojärjestelmästä. Rajaus, kuvatekstit ja automaattinen numerointi.",
    rs_feat5_title: "Monikielinen", rs_feat5_desc: "Kirjoita raportteja ruotsiksi, englanniksi ja muilla kielillä. Vaihda kieltä raporteittain.",
    rs_feat6_title: "Älykäs haku", rs_feat6_desc: "Löydä raportit, projektit ja asiakkaat tehokkaalla haulla. Suodata päivämäärän, tilan, tyypin ja vapaan tekstin mukaan.",
  ...
  pl: {
    ...
    rs_hero_desc: "Kompletny generator raportów dla budownictwa, kierowników projektów i branży wilgotnościowej i szkodowej. Twórz profesjonalne raporty z protokołami pomiarowymi, zarządzaniem zdjęciami, eksportem PDF i obsługą wielojęzyczną — bezpośrednio w przeglądarce.",
    ...
    rs_feat4_title: "Zarządzanie zdjęciami", rs_feat4_desc: "Dodawaj zdjęcia z aparatu lub systemu plików. Kadrowanie, podpisy i automatyczna numeracja.",
    rs_feat5_title: "Wielojęzyczny", rs_feat5_desc: "Pisz raporty po szwedzku, angielsku i w innych językach. Zmień język per raport.",
    rs_feat6_title: "Inteligentne wyszukiwanie", rs_feat6_desc: "Znajdź raporty, projekty i klientów dzięki potężnemu wyszukiwaniu. Filtruj po dacie, statusie, typie i wolnym tekście.",
